Build the Windows version of ASM71 with MSVC 2022
...
Build:
run build_asm71.cmd compiles ASM71 and creates a windows installer for the current build tool 
...
If build_asm71.cmd is invoked with the parameter "TEST" then the test suite is run. This requires a Python 3 interpreter installed on the system.
