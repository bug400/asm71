...
!include "..\nsis\UninstallFiles.nsh"
	...
	${if} "$StartMenuFolder" != ""
		...
		${endif}
		!insertmacro DeleteRetryAbort "$SMPROGRAMS\$StartMenuFolder\Documentation.lnk"
...
Function un.onInit
	...
	; read registry value PathModified
	ReadRegStr $PathModified "${MUI_LANGDLL_REGISTRY_ROOT}" "${MUI_LANGDLL_REGISTRY_KEY}" "PathModified"
FunctionEnd
